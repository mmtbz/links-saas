        ...
        <AlertDialog.Root>
          <AlertDialog.Trigger>
            <Flex
              direction="column"
              gap="3"
              className="border border-solid bg-gray-50 border-gray-200 rounded-[15px] p-4"
            >
              <Box>
              ...
              <Box className="uppercase text-xs">
                ...
                <Text className="opacity-70">people took it in past month</Text>
              </Box>
            </Flex>
          </AlertDialog.Trigger>
          <AlertDialog.Content
