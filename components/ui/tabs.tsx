...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center lg:justify-start rounded-md bg-muted p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
